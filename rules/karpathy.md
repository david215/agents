...
on LLM coding pitfalls, via [forrestchang/andrej-karpathy-skills](https://github.com/forrestchang/andrej-karpathy-skills)
(MIT — see [`LICENSE-karpathy`](../LICENSE-karpathy)). Locally edited; see the README.
