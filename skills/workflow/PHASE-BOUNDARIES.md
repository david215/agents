...
Adapted from Matt Pocock's `ask-matt` skill ([mattpocock/skills](https://github.com/mattpocock/skills), MIT), co-located here because `/workflow` is its only consumer.
